      ...
      <main style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '1rem 1.5rem 3rem' }}>
        <div className="ob-card">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            {step === 5 && (
              <>
                {/* margin extra compensa el hueco del .ob-desc que no llevamos
                    en este step — mantiene el mismo ritmo vertical del resto. */}
                <h2 className="ob-title" style={{ marginBottom: '1.9rem' }}>¿Cómo vas a pagar?</h2>
                <div className="ob-options">
                  {[
