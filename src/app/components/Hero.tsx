    ...
    >
      ...
      <div className="relative z-[10] w-full flex flex-col items-center justify-center" style={{ minHeight: '100svh' }}>
        <div className="max-w-[700px] mx-auto px-5 sm:px-8 text-center" style={{ paddingTop: '7rem', paddingBottom: '6rem' }}>
          ...
          {/* Description */}
          <motion.p
            className="text-[15px] sm:text-base text-white/80 leading-relaxed mb-10 sm:mb-12 mx-auto max-w-[480px] font-medium"
            variants={fadeUp}
            initial="hidden"
            animate="visible"
          ...
          >
            <motion.button
              ...
              className="bg-white text-[var(--purple)] border-none px-8 sm:px-10 py-4 rounded-full text-[15px] sm:text-base font-bold cursor-pointer font-['DM_Sans'] whitespace-nowrap group flex items-center gap-2 w-full sm:w-auto justify-center"
