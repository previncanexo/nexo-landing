...
export function Hero() {
  return (
    <section
      id="hero"
      className="relative overflow-hidden pt-20 pb-0 sm:pt-28 sm:pb-0 md:pt-32"
    >
      {/* Grain overlay */}
      <div
      ...
      {/* Decorative orbs */}
      <div className="absolute top-10 right-[5%] w-[500px] h-[500px] rounded-full bg-[var(--pink)] opacity-20 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-[5%] w-[400px] h-[400px] rounded-full bg-[var(--purple)] opacity-15 blur-[100px] pointer-events-none" />

      <div className="max-w-[1200px] mx-auto px-5 sm:px-6 relative z-[2]">
        <div className="flex flex-col md:flex-row md:items-end gap-10 md:gap-8">

          {/* ── LEFT: text content ── */}
          <div className="flex-1 pb-12 md:pb-20 text-center md:text-left">
            {/* Badge */}
            <motion.div
            ...
            >
              <h1 className="font-['DM_Serif_Display'] leading-tight tracking-[-1px] sm:tracking-[-2px] md:tracking-[-3px] mb-3">
                <span className="block text-[clamp(36px,7vw,80px)] text-white">Tu salud,</span>
                <span className="block text-[clamp(36px,7vw,80px)] text-white italic">digitalmente simple</span>
              </h1>
            </motion.div>

            {/* Description */}
            <motion.p
              className="text-[15px] sm:text-lg text-white/85 leading-relaxed mb-7 sm:mb-10 max-w-[520px] font-medium mx-auto md:mx-0"
              variants={fadeUp}
              initial="hidden"
              animate="visible"
            ...
            {/* CTAs */}
            <motion.div
              className="flex gap-3 flex-col sm:flex-row max-w-[400px] sm:max-w-none mx-auto md:mx-0 justify-center md:justify-start"
              variants={fadeUp}
              initial="hidden"
              animate="visible"
          ...
          {/* ── RIGHT: hero photo ── */}
          <motion.div
            className="hidden md:flex flex-shrink-0 items-end justify-center md:justify-end"
            style={{ width: 'clamp(340px, 42%, 520px)' }}
          ...
          >
            <img
              ...
              style={{
                maxHeight: '640px',
                filter: 'drop-shadow(0 32px 64px rgba(134,96,239,0.30))',
              }}
              draggable={false}
            />
          </motion.div>
