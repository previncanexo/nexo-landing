  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, rgba(18,5,61,0.75) 0%, rgba(18,5,61,0.20) 45%, transparent 100%)',
            }}
          />
      ...
      <button
        ...
        className="absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
      ...
      <button
        onClick={next}
        className="absolute right-4 sm:right-6 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
        style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.25)' }}
